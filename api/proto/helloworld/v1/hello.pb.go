...
// 	protoc        v5.29.3
// source: api/proto/helloworld/v1/hello.proto
...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_helloworld_v1_hello_proto_rawDescGZIP(), []int{0}
}
...
const file_api_proto_helloworld_v1_hello_proto_rawDesc = "" +
	...
	"\aGreeter\x12D\n" +
	"\bSayHello\x12\x1b.helloworld.v1.HelloRequest\x1a\x19.helloworld.v1.HelloReply\"\x00B6Z4github.com/coreguard/gateway/api/proto/helloworld/v1b\x06proto3"

var (
	file_api_proto_helloworld_v1_hello_proto_rawDescOnce sync.Once
	file_api_proto_helloworld_v1_hello_proto_rawDescData []byte
)
